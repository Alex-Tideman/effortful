...
ActiveRecord::Schema.define(version: 20150929143755) do
  ...
  add_index "schedules", ["effort_id"], name: "index_schedules_on_effort_id", using: :btree
  ...
  add_foreign_key "schedules", "efforts"
